...
use App\Mail\ProyectoFinalizadoMail;
use Illuminate\Support\Facades\Cache;
use Carbon\Carbon;
use Illuminate\Support\Facades\Log;

class SendProyectoFinalizadoMail implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if (Cache::has($cacheKey)) {
            ...
            if ($emailCount < $quotaLimit) {
                ...
                Mail::to($this->emailDetails['email'])->send(new ProyectoFinalizadoMail($this->emailDetails));
